...
class Dataset(object):
    ...
    dataset_name = 'COCO'
    dataset_1 = 'video_prueba-imagenes'
    num_kps = 17
    ...
    human_det_path = osp.join('..', 'data', dataset_1, 'dets', 'human_detection.json') # human detection result
    img_path = osp.join('..', 'data', dataset_1, 'images')
    ...
    test_annot_path = osp.join('..', 'data', dataset_1, 'annotations', 'image_info_test2017.json')
